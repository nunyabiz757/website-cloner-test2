    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Preview Projects</h1>
          <p className="text-gray-600 mb-8">Select a project to preview</p>
          ...
          {projects.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {projects.filter(p => p.status === 'completed').map((proj) => (
                <div
                  key={proj.id}
                  onClick={() => navigate(`/preview/${proj.id}`)}
                  className="bg-white border border-gray-200 rounded-xl p-6 hover:border-blue-500 hover:shadow-lg transition-all cursor-pointer"
                >
            ...
            <div className="text-center py-16">
              ...
              <p className="text-gray-600 mb-6">Analyze a website first to preview it</p>
